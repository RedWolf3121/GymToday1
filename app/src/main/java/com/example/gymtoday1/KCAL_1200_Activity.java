...
public class KCAL_1200_Activity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kcal_1200_);
        ...
        mDetector = new GestureDetector(this, new KCAL_1200_Activity.MyGestureListener());
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.kcal_1200_, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            Intent intent = new Intent(KCAL_1200_Activity.this, CronometroActivity.class);
            startActivity(intent);

        } else if (id == R.id.nav_Calendario) {
            Intent intent = new Intent(KCAL_1200_Activity.this, CalendarioActivity.class);
            startActivity(intent);

        } else if (id == R.id.nav_Notas) {
            Intent intent = new Intent(KCAL_1200_Activity.this, NotasActivity.class);
            startActivity(intent);
